...
```lua
loadstring(game:HttpGet('https://raw.githubusercontent.com/Bero667/lib/refs/heads/main/library.lua'))() -- returns Menu
UILib:ShowDemoMenu()
```
...
Menu:RegisterActivity(callback: function) -> Activity
